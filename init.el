...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "Source Code Pro" :foundry "adobe" :full normal :weight semi-bold :height 83 :width normal :full normal :full normal :full normal :full normal :slant normal)))))
