...
:ensure t
:bind (("C-s" . helm-cscope-find-symbol)
("C-g" . helm-cscope-find-global-definition)
("M-c f" . helm-cscope-find-called-function)
("M-c c" . helm-cscope-find-calling-this-function)
